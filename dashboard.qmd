...
| ------------------------------------- | ------------------------------------------------------------------ |----------------------------------------- |
|      DWH                              |  (SQL Microsoft Server)   Base de datos en cual se almacena información básica de productos y de todas las facturas realizadas.  |  Información relacionada con facturas de venta y con costo de productos.|
|      ct_online2                       |  (SQLite)  Base de datos en cual se almacena información básica de productos     |  Categoría al cual pertenece cada producto.|
|      CT_API_Publica                   |  (mongodb) Base de datos variada en cual se almacena información de facturas,paquetería, existencia de productos etc. | Información actualizada de almacenamiento y existencia de productos. |
|      CT_Historico                     |  (mongodb) Base de datos en cual se almacena histórica de almacenamiento y existencia de productos |  Información histórica de almacenamiento y existencia de productos. |
